...
<html>
<head>
<title>Museu do Brinquedo Popular MERGE 2</title>
...
<meta name="keywords" content="brinquedos, divers�o, sonhos, David Glat, popular" />
    ...
    <table align='center' style='background-color: #ffffff; width: 930px;height: 600px; padding: 30px;'>
        <tr><td valign="top" style='padding-top: 20px; padding-left: 20px;'>
            ...
            set rs = MyConn.Execute(strSQL)
                ...
                saida = saida & "       <br /><br /><a href='artistainfo.asp?id="&rs("id_autor")&"' alt='Informa��es sobre "&rs("nome_autor")&"' target='_self'><img src='imagens/biografia.png' border='0' /></a>"
                saida = saida & "   </div>"
